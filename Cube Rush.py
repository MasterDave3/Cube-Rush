...
bannana = pygame.image.load("Bannana.png")
ground_with_grass = pygame.image.load("Ground_with_grass.png").convert_alpha()
ground = pygame.image.load("Ground.png").convert_alpha()
water_fall = pygame.image.load("Waterfall.png").convert_alpha()
moon1 = pygame.image.load("moon.png").convert_alpha()
